...
console.log(receball.length)


// Comando .sort() ele organiza os itens em ordem crescente

let frutas3 = ["Banana", "Maça", "Laranja"];
frutas3.sort();
